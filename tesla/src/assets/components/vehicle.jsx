      ...
      <div className="relative w-full bg-white text-black" style={{ height: '560px' }}>
        ...
        <div className="flex flex-row">
          ...
          <div className="flex flex-col items-start mb-12 mt-2" style={{ marginLeft: '160px' }}>
            <img className="w-44 h-54" src="https://digitalassets.tesla.com/tesla-contents/image/upload/f_auto,q_auto/Mega-Menu-Vehicles-Model-S.png" />
          ...
          <div className="flex flex-col items-start mb-12 mt-2" style={{ marginLeft: '20px' }}>
            <img className="w-44 h-54" src="https://digitalassets.tesla.com/tesla-contents/image/upload/f_auto,q_auto/Mega-Menu-Vehicles-Model-3-Performance-LHD.png" />
          ...
          {/* Model X*/}
          <div className="flex flex-col items-start mb-12 mt-2" style={{ marginLeft: '20px' }}>
            <img className="w-44 h-54" src="https://digitalassets.tesla.com/tesla-contents/image/upload/f_auto,q_auto/Mega-Menu-Vehicles-Model-X.png" />
           ...
           {/*Model Y*/}
          <div className="flex flex-col items-start mb-12 mt-2" style={{ marginLeft: '20px' }}>
            <img className="w-44 h-54" src="https://digitalassets.tesla.com/tesla-contents/image/upload/f_auto,q_auto/Mega-Menu-Vehicles-Model-Y.png" />
          ...
          {/*CyberTruck*/}
          <div className="flex flex-col items-start mb-12 mt-40" style={{position:'absolute', width:'269px', height:'177px',left:'141px',top:'176px'}}>
            <img className="w-44 h-54" src="https://digitalassets.tesla.com/tesla-contents/image/upload/f_auto,q_auto/Mega-Menu-Vehicles-Cybertruck-1x.png" />
          ...
          {/*Help me to choose*/}
          <div className="flex flex-col items-start mb-12 mt-40" style={{position:'absolute', width:'269px', height:'177px',left:'341px',top:'176px'}}>
            <img className="w-44 h-54" src="https://digitalassets.tesla.com/tesla-contents/image/upload/f_auto,q_auto/Mega-Menu-Vehicles-HMC-RedBlue-LHD.png" />
          ...
          {/*vertical line*/}
          <div className="absolute" style={{ right: '500px', top: '140px', height: '320px', width: '1px', backgroundColor: 'gray' }}></div>
          <ul className="absolute text-black font-semibold py-2" style={{right:'320px', top:'140px',height:'320px',}}>
